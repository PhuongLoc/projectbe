			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> 0398887777</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> shopdienthoai@gmail.com</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i> 777 Võ Văn Ngân</a></li>
					</ul>
					<ul class="header-links pull-right">
						<li><a href="#"><i class="fa fa-dollar"></i> USD</a></li>
						<?php if(!isset($_SESSION['username'])): ?>
							<li><a href="./login/login.php"><i class="fa fa-user-o"></i> Tài khoản</a></li>	
						<?php else: ?>
							...
							<div class="header-ctn">
								...
								<div class="dropdown">
									...
									<div class="cart-dropdown">
										...
										<div class="cart-btns">
											<a href="blank.php">Xem giỏ hàng</a>
											<a href="checkout.php">Kiểm tra lại  <i class="fa fa-arrow-circle-right"></i></a>
										</div>
									</div>
								</div>
								<!-- /Cart -->
